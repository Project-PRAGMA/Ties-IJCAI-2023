...
models = [{"model_id": 'resampling', "params_family": {"p": [2*k/m], "phi": [0.25, 0.5, 0.75]}}]
...
elections_df.to_csv(f"{dir_csv}/mapel_with_random_resampling_ns_{ns_name_to_save}_m_{m}_k_{k}_reps_{reps}_top.csv")
...
elections_results_df.to_csv(f"{dir_csv}/mapel_with_random_resampling_ns_{ns_name_to_save}_m_{m}_k_{k}_reps_{reps}_top_results.csv")
...
pd.DataFrame(stats_map).to_csv(f"{dir_csv}/mapel_with_random_resampling_ns_{ns_name_to_save}_m_{m}_k_{k}_reps_{reps}_top_stats.csv")
